...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glLoadIdentity();
		...
		//OREJA IZQUIERDO
		glPushMatrix();
		glTranslatef(2.35, 0.65, -0.25);
		glScalef(0.2, 0.3, 0.35);
